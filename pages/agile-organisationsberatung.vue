...
useHead({
  ...
  meta: [
  { property: "og:title", content: t('seo.organizationConsulting.title') },
    { property: "og:description", content: t('seo.organizationConsulting.description') },
  ]
})
</script>
...
<script>
export default {
  name: 'agileOrganisationsberatung',
}
</script>
<style scoped>
