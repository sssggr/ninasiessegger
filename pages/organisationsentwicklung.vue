...
useSeoMeta({
  ...
  ogTitle: "Agile Organisationsentwicklung",
...
<template>
  <div class="row">
    <div class="col-xs-12 col-md-offset-1 col-lg-offset-2 col-lg-9 col-md-10">
      ...
      <p class="z-100">Als Organisationsentwicklerin begleite ich Organisationen, Teams und Mitarbeitende auf dem Weg zu einer agilen und zukunftsfähigen Organisation.</p>
...
<script>
export default {
  name: 'agile-organisationsentwicklung',
}
</script>
<style scoped>
