  ...
  <div>
    <div class="row">
      <div class="col-xs-12 col-lg-offset-1 col-lg-10 col-md-12">
        ...
        <h3 class="z-100">Agil in die digitale Zukunft mit dem INQA-Förderprogramm für KMU</h3>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-xs-12 col-md-12 col-lg-offset-1 col-lg-10">
        ...
        <p class="z-100">Der Ablauf des INQA-Coachings gliedert sich in drei Phasen:</p>
        <ol class="z-100">
          <li>Initialphase (Dauer: ca. 1 Monat)</li>
          <li>Innovationsphase ( Dauer: 3-4 Monate)</li>
          <li>Lernphase (Dauer: 1 Monat)</li>
        </ol>
        <img alt="INQA Vorgehen" class="responsive-img" src="~/assets/images/inqa-vorgehen.jpg">
        <p class="z-100">
